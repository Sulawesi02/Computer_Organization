...
module inst_rom(
    ...
    wire [31:0] inst_rom[22:0];  // 指令存储器，字节地址7'b000_0000~7'b111_1111
    //------------- 指令编码 ---------|指令地址|--- 汇编指令 -----|- 指令结果 -----//
    ...
    assign inst_rom[19] = 32'h00C74801; // 4CH: sgt   $9 ,$6,$7   | $9 = 0000_0000H
    assign inst_rom[20] = 32'h00E6401B; // 50H: xnor  $8 ,$7,$6   | $8 = FFFF_FFEEH
    assign inst_rom[21] = 32'h540C000C; // 54H: lli   $12,#12     | [R12] = 0000_000CH
